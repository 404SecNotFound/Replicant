            ...
            events.append(
                EventRecord(
                    ...
                    extra={
                        ...
                        "sentpkt": str(packet_count(out_b, typical_mss=150, spread=80)),
                        "rcvdpkt": str(packet_count(in_b, typical_mss=150, spread=80)),
                    },
                )
            )
            session += 1
            ...
            events.append(
                EventRecord(
                    ...
                    extra={
                        ...
                        "trandisp": "snat",
                        "duration": str(duration),
                        "sentpkt": str(packet_count(out_b)),
                        "rcvdpkt": str(packet_count(in_b)),
                    },
                )
            )
            session_id += 1
